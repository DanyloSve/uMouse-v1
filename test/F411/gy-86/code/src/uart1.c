...
volatile uint8_t UART1_DMAbufferTX[40];
volatile uint8_t UART1_DMAbufferRX[2];
...
void UART1_DMA2_Init(void)
{
	...
	*/
	...
	DMA2->HIFCR      |= DMA_HIFCR_CTCIF5;     		// clear transfer complete flag
...
//		UART1_DMAbufferTX[0] = UART1_DMAbufferRX[0];
//		UART1_DMAbufferTX[1] = 'h';
//		UART1_DMAbufferTX[2] = 'e';
//		UART1_DMAbufferTX[3] = 'l';
//		UART1_DMAbufferTX[4] = 'l';
//		UART1_DMAbufferTX[5] = 'o';
//		//UART1_DMAbufferTX[6] = '\n';
//		UART1_DMA_Send();
